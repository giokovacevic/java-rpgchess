...
public class Hero extends Unit{
    ...
    public String toString() {
        String str = "hero" + " " + getId() + " " + String.valueOf(getControllerId()) + " " + String.valueOf(getDirection()) + " " + String.valueOf(getMaxHealth()) + " " + String.valueOf(getCurrentHealth()); // id alliance direction maxHp currentHp
        return str;
    }
    ...
    public Hero copy() {
        return new Hero(
            ...
            this.getClass_(),
            this.getLevel(),
            this.getPrimaryWeapon().copy(),
            this.getSecondaryWeapon().copy()
        );
    }
    ...
    @Override
    public int getAccuracy() { // TODO: ACCURACY NOT IMPLEMENTED FOR HERO
        return 0;
    }
    @Override
